...
blob_bot_routes = Blueprint("blob_bot_routes", __name__)
logger.debug("[DEBUG] Blob bot routes blueprint created")
tracking_routes = Blueprint("tracking_routes", __name__)
logger.debug("[DEBUG] Tracking routes blueprint created")
recommendation_bp = Blueprint('recommendation', __name__)
logger.debug("[DEBUG] Recommendation routes blueprint created")